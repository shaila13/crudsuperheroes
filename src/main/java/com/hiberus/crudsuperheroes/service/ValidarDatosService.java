...
public interface ValidarDatosService {
	...
	/**
	 * Se valida el id para realizar las operaciones de busqueda o borrdao de un
	 * super heroe.
	 * 
	 * @param id
	 * @throws ValidationException
	...
	/**
	 * Se valida el parametro para realizar la operacion de busqueda de uno o varios
	 * super heroes.
	 * 
	 * @param parametro
	 * @throws ValidationException
